...
$('button').on('click', function () {
  ...
  if (!colorOne && !colorTwo && !colorThree) {
    ...
    hexArray = []
    weight = [Number(Slider1.value), 0, 0]
    // document.getElementById('range1').innerHTML = 100 + '%' //new code
    ...
    RGB = []
    hexArray = []
    weight = [Number(Slider1.value), Number(Slider2.value), 0]
    // document.getElementById('range1').innerHTML = 100 + '%' //new code
    // document.getElementById('range2').innerHTML = 100 + '%' //new code
    ...
    weight = [Number(Slider2.value)/100, 0, 0]
    // document.getElementById('range1').innerHTML = 100 + '%'  //new code
    // document.getElementById('range2').innerHTML = 100 + '%'
    ...
    weight = [Number(Slider3.value)/100, 0, 0]

    // document.getElementById('range1').innerHTML = 100 + '%'  //new code
    // document.getElementById('range1').innerHTML = 100 + '%'
    // document.getElementById('range3').innerHTML = 100 + '%'
    // Slider3.value = Slider3.value
    RGB = []
    ...
    RGB = []
    hexArray = []
    weight = [Number(Slider1.value)/100, Number(Slider3.value)/100, 0]
    // document.getElementById('range1').innerHTML = 100 + '%' //new code
    // document.getElementById('range3').innerHTML = 100 + '%' //new code
    // Slider1.value = Slider1.value
    // Slider3.value = Slider3.value
    ...
    RGB = []
    hexArray = []
    weight = [Number(Slider2.value)/100, Number(Slider3.value)/100, 0]
    // document.getElementById('range2').innerHTML = 100 + '%' //new code
    // document.getElementById('range3').innerHTML = 100 + '%' //new code
    // Slider2.value = Slider2.value
    // Slider3.value = Slider3.value
