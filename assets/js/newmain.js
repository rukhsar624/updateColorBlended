...
var getAvg1 = function (list) {
  ...
  var weight_total = 0
  console.log(list, 'RGB')
  console.log(weight, 'weight Array')
  list.map((elem, i) => {
...
$('button').on('click', function () {
  ...
  if (!colorOne && !colorTwo && !colorThree) {
    ...
    weight = [Number(Slider1.value) / 100]
    RGB = []
    const rgb = colorOne
    ...
    RGB = []
    weight = [Number(Slider1.value) / 100, Number(Slider2.value) / 100]
    ...
    weight = [Number(Slider2.value) / 100]
    ...
    weight = [Number(Slider3.value) / 100]

    RGB = []
    const rgb = colorThree
    ...
    weight = [Number(Slider1.value) / 100, Number(Slider3.value) / 100]
    const rgb1 = colorOne
      .substring(4, colorOne.length - 1)
      .replace(/ /g, '')
      .split(',')
    ...
    weight = [Number(Slider2.value) / 100, Number(Slider3.value) / 100]
    ...
    RGB = []
    weight = [
      Number(Slider1.value) / 100,
      Number(Slider2.value) / 100,
      Number(Slider3.value) / 100,
    ]
